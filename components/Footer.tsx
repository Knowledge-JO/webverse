       ...
       <div className="">
            <div className="mt-[300px] md:mt-[400px] flex flex-col lg:flex-row items-center justify-center gap-20 mb-14 ">
                <div className="text-center lg:text-left">
                    <p className="font-bold px-10 md:px-0 md:text-2xl w-[350px] mb-3">MEET CREATORS OF THE WEBVERSE</p>
                ...
                <div>
                    ...
                    <div className="text-center w-[350px]">
                        <p className="font-bold text-3xl mb-3">Entangle</p>
                        <p className="px-10 md:px-0 text-[15px] md:text-base">Customizable & Interoperable Data InfrastructureBuilt for Web3 and Institutions</p>
                    </div>
                </div>
            </div>
